...
export const CalendlyModal = ({ buttonColor, buttonTextColor }: {buttonColor: string, buttonTextColor: string}) => {
    ...
    <>
      ...
      {isOpen && (
        <div className={`fixed inset-0 z-50 flex items-center justify-center bg-${buttonColor}/70 backdrop-blur-sm`}>
          <div className={`bg-${buttonColor} rounded-2xl shadow-xl max-w-4xl w-full p-6 relative`}>
            <button
